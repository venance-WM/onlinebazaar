    ...
    <header class="profile-header container overflow-hidden">
        <div class="card-body p-0">
            ...
            <div id="carouselControls" class="carousel slide carousel-fade d-md-none d-lg-none" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset($seller->sellerDetail->shop_image_one ? 'images/shop_cover_images/' . $seller->sellerDetail->shop_image_one : 'app/placeholder-16-9.png') }}"
                            class="d-block w-100 img-fluid" alt="Shop Image 1" style="height: 250px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset($seller->sellerDetail->shop_image_two ? 'images/shop_cover_images/' . $seller->sellerDetail->shop_image_two : 'app/placeholder-16-9.png') }}"
                            class="d-block w-100 img-fluid" alt="Shop Image 2" style="height: 250px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset($seller->sellerDetail->shop_image_three ? 'images/shop_cover_images/' . $seller->sellerDetail->shop_image_three : 'app/placeholder-16-9.png') }}"
            ...
            <div class="row no-gutters d-none d-md-flex d-lg-flex">
                <div class="col-md-4">
                    <img src="{{ asset($seller->sellerDetail->shop_image_one ? 'images/shop_cover_images/' . $seller->sellerDetail->shop_image_one : 'app/placeholder-16-9.png') }}"
                        class="img-fluid border border-dark" alt="Shop Image 1 here" style="height: 250px; object-fit: cover;">
                </div>
                <div class="col-md-4">
                    <img src="{{ asset($seller->sellerDetail->shop_image_two ? 'images/shop_cover_images/' . $seller->sellerDetail->shop_image_two : 'app/placeholder-16-9.png') }}"
                        class="img-fluid border border-dark" alt="Shop Image 2 here" style="height: 250px; object-fit: cover;">
                </div>
                <div class="col-md-4">
                    <img src="{{ asset($seller->sellerDetail->shop_image_three ? 'images/shop_cover_images/' . $seller->sellerDetail->shop_image_three : 'app/placeholder-16-9.png') }}"
